...
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
	...
	public void setSource(State newSource) {
		if (newSource != eInternalContainer()
			...
			if (newSource != null)
				msgs = ((InternalEObject) newSource).eInverseAdd(this, FsmPackage.STATE__OUTGOING_TRANSITIONS,
						State.class, msgs);
	...
	public NotificationChain basicSetTarget(State newTarget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					FsmPackage.TRANSITION__TARGET, oldTarget, newTarget);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTarget(State newTarget) {
		if (newTarget != target) {
			NotificationChain msgs = null;
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this, FsmPackage.STATE__INCOMING_TRANSITIONS,
						State.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject) newTarget).eInverseAdd(this, FsmPackage.STATE__INCOMING_TRANSITIONS,
						State.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case FsmPackage.TRANSITION__SOURCE:
			return eInternalContainer().eInverseRemove(this, FsmPackage.STATE__OUTGOING_TRANSITIONS, State.class, msgs);
		}
